...
model_path = "/data/SSD1/data/weights/dpt_swin2_tiny_256.pt"
...
torch.onnx.export(
    ...
    "./work_dirs/"
    + model_type
    + "_model.onnx",  # where to save the model (can be a file or file-like object)
...
# Load the ONNX model
session = onnxruntime.InferenceSession("./work_dirs/" + model_type + "_model.onnx")
...
plt.savefig("./code_v2_" + model_type + "_onnx.png")
